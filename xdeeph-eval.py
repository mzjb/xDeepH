...
# Default config file for evaluation is xdeeph/default_configs/eval_default.ini

import os
import argparse

parser = argparse.ArgumentParser(description='Evaluate xDeepH model to get hamiltonians_pred.h5')
